// infinite scrolling -- no need to of next or previous page;
...
const News = (props)=> {
  ...
  const fetchMoreData = async () => {
    ...
    return (
      <>
        <h1 className="text-center" style={{ margin: "34px 0px", marginTop: '90px' }}>
          NewsPlus - Top {capitalizeFirstLetter(props.category)}{" "}
          Headlines
        </h1>
        {loading && <Spinner />}
